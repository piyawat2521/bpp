...
$arrayPage3 = array("", "" . $_POST["h7"] . "", "" . $_POST["h8"] . "", "" . $_POST["h9"] . "", "" . $_POST["h10"] . "", "" . $_POST["h11"] . "", "" . $_POST["cv2"] . "");
...
if ($sumPage3 >= 0.00 and $sumPage3 <= 24.00) {
...
} elseif ($sumPage3 >= 25.00 and $sumPage3 <= 49.99) {
...
} elseif ($sumPage3 >= 50.00 and $sumPage3 <= 74.99) {
...
} elseif ($sumPage3 >= 75.00 and $sumPage3 <= 100) {
    $imgS = '<img src="imgS/s3.png">';
