                ...
                <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="sex" class="form-check-input sex" id="sex" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. ชาย</label>
                                    </div>

                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="sex" class="form-check-input sex" value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2. หญิง</label>
                                    </div>

                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="sex" class="form-check-input sex" value="3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="materialGroupExample2"> 2. ไม่ใช่</label>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="materialGroupExample2"> 2. บ้านผ่อน</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="3">
                                        <label class="form-check-label" for="materialGroupExample3"> 3. บ้านเช่า/
                                            ห้องเช่า</label>
                                    </div>
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4. บ้าน/ ห้อง
                                            ไม่เสียค่าเช่า</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="5">
                                        <label class="form-check-label" for="materialGroupExample3"> 5. คอนโด/
                                            อพาร์ทเม้นท์ที่ท่านเป็นเจ้าของ</label>
                                    </div>
                                    <!-- Group of material radios - option 6 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="6">
                                        <label class="form-check-label" for="materialGroupExample3"> 6. คอนโด/
                                            อพาร์ทเม้นท์ ผ่อน</label>
                                    </div>
                                    <!-- Group of material radios - option 7 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="7">
                                        <label class="form-check-label" for="materialGroupExample3"> 7. คอนโด/
                                            อพาร์ทเม้นท์เช่า</label>
                                    </div>
                                    <!-- Group of material radios - option 8 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_4" class="form-check-input 2_4" id="2_4" value="8">
                                        <label class="form-check-label" for="materialGroupExample3"> 8. คอนโด/
                                            อพาร์ทเม้นท์ ไม่เสียค่าเช่า</label>
                                    </div>
                                    <!-- Group of material radios - option 8 -->
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_1" class="form-check-input p2_5" id="2_5_1"
                                            value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1.
                                            อยู่คนเดียว</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_2" class="form-check-input p2_5" id="2_5_2"
                                            value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2. คู่สมรส (สามี/
                                            ภรรยา)</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_3" class="form-check-input p2_5" id="2_5_3"
                                            value="3">
                                    ...
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_4" class="form-check-input p2_5" id="2_5_4"
                                            value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4. พ่อแม่/
                                            พ่อแม่บุญธรรม/ พ่อแม่เลี้ยง</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_5" class="form-check-input p2_5" id="2_5_5"
                                            value="5">
                                    ...
                                    <!-- Group of material radios - option 6 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_6" class="form-check-input p2_5" id="2_5_6"
                                            value="6">
                                        <label class="form-check-label" for="materialGroupExample3"> 6. ลูก/ ลูกบุญธรรม/
                                            ลูกเลี้ยง</label>
                                    </div>
                                    <!-- Group of material radios - option 7 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_7" class="form-check-input p2_5" id="2_5_7"
                                            value="7">
                                    ...
                                    <!-- Group of material radios - option 8 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_8" class="form-check-input p2_5" id="2_5_8"
                                            value="8">
                                        <label class="form-check-label" for="materialGroupExample3"> 8. เพื่อน</label>
                                    </div>
                                    <!-- Group of material radios - option 8 -->
                                    <div class="form-check">
                                        <input type="checkbox" name="2_5_9" class="form-check-input p2_5" id="2_5_9"
                                            value="9">
                                        <label class="form-check-label" for="materialGroupExample3"> 9. คู่รัก/ คนรัก/
                                            แฟน</label>
                                    </div>
                                    <!-- Group of material radios - option 9 -->
                                    <div class="form-check inputAll">
                                        <input type="checkbox" name="2_5_10" class="form-check-input" id="2_5_10"
                                            value="10">
                                        <label class="form-check-label" for="materialGroupExample3"> 10. อื่นๆ
                                            (โปรดระบุ) <input type="text" name="2_5t" id="2_5t"
                                                class="form-control inputText"></label>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    ...
                                    <div class="form-check inputAll">
                                        ...
                                        <label class="form-check-label" for="materialGroupExample3"> 10. อื่นๆ
                                            (โปรดระบุ) <input type="text" name="2_6t" id="2_6t"
                                                class="form-control inputText"></label>
                                    </div>
                                </div>
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. โสด</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2.
                                            แต่งงานและอยู่ร่วมกัน</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="3">
                                        <label class="form-check-label" for="materialGroupExample3"> 3.
                                            แต่งงานแต่ไม่ได้อยู่ด้วยกัน</label>
                                    </div>
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4.
                                            อยู่ด้วยกันโดยไม่ได้แต่งงาน</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="5">
                                        <label class="form-check-label" for="materialGroupExample3"> 5. หม้าย</label>
                                    </div>
                                    <!-- Group of material radios - option 6 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_7" class="form-check-input p2_7" value="6">
                                        <label class="form-check-label" for="materialGroupExample3"> 6.
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_8" class="form-check-input p2_8" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. ไม่มี</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_8" class="form-check-input p2_8" value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2. มี จำนวน 1
                                            คน</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_8" class="form-check-input p2_8" value="3">
                                        <label class="form-check-label" for="materialGroupExample3"> 3. มี จำนวน 2
                                            คน</label>
                                    </div>
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_8" class="form-check-input p2_8" value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4. มี จำนวน 3-4
                                            คน</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_8" class="form-check-input p2_8" value="5">
                                        <label class="form-check-label" for="materialGroupExample3"> 5. มี จำนวนตั้งแต่
                                            5 คนขึ้นไป</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Default input -->
                                <label for="exampleForm2" class="textQ">2.9 ขณะนี้ท่านกำลังตั้งครรภ์หรือไม่
                                    (ถามเฉพาะเพศหญิง)</label>
                                <!-- Group of material radios - option 1 -->
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_9" class="form-check-input p2_9" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1.
                                            ตั้งครรภ์</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_9" class="form-check-input p2_9" id="p2_9"
                                            value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2.
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Default input -->
                                <label for="exampleForm2" class="textQ">2.10 ท่านทำงานเป็นกะ/ ทำงานเป็นรอบ/ เข้าเวร
                                    ใช่หรือไม่</label>
                                <!-- Group of material radios - option 1 -->
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_10" class="form-check-input p2_10" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. ไม่ใช่</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Default input -->
                                <label for="exampleForm2" class="textQ">2.11 ระยะเวลาที่ท่านทำงานในองค์กรปัจจุบัน
                                    รวมทั้งหมด</label>
                                <!-- Group of material radios - option 1 -->
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_11" class="form-check-input p2_11" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. ไม่ถึงปี</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_11" class="form-check-input p2_11" value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2. ระหว่าง 1 - 2
                                            ปี</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_11" class="form-check-input p2_11" value="3">
                                        <label class="form-check-label" for="materialGroupExample3"> 3. ระหว่าง 3 - 5
                                            ปี</label>
                                    </div>
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_11" class="form-check-input p2_11" value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4. ระหว่าง 6 - 9
                                            ปี</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_11" class="form-check-input p2_11" value="5">
                                        <label class="form-check-label" for="materialGroupExample3"> 5. ตั้งแต่ 10 ปี
                                            ขึ้นไป</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Default input -->
                                <label for="exampleForm2" class="textQ">2.12 ตั้งแต่เริ่มทำงานจนถึงปัจจุบัน
                    ...
                    <div class="container boxQ">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Default input -->
                                <label for="exampleForm2" class="textQ">2.13 ท่านมีรายได้ต่อเดือน โดยประมาณเดือนละเท่าใด
                                    (รายได้+เงินเดือน+ค่าตอบแทนอื่นๆ)</label>
                                <!-- Group of material radios - option 1 -->
                                <div class="boxA">
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="1">
                                        <label class="form-check-label" for="materialGroupExample1"> 1. น้อยกว่า 10,000
                                            บาท</label>
                                    </div>
                                    <!-- Group of material radios - option 2 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="2">
                                        <label class="form-check-label" for="materialGroupExample2"> 2. 10,001 - 20,000
                                            บาท</label>
                                    </div>
                                    <!-- Group of material radios - option 3 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="3">
                                        <label class="form-check-label" for="materialGroupExample3"> 3. 20,001 - 30,000
                                            บาท</label>
                                    </div>
                                    <!-- Group of material radios - option 4 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="4">
                                        <label class="form-check-label" for="materialGroupExample3"> 4. 30,001 -
                                            40,000บาท</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="5">
                                        <label class="form-check-label" for="materialGroupExample3"> 5. 40,001 - 50,000
                                            บาท</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="6">
                                        <label class="form-check-label" for="materialGroupExample3"> 6. 50,001 - 100,000
                                            บาท</label>
                                    </div>
                                    <!-- Group of material radios - option 5 -->
                                    <div class="form-check">
                                        <input type="radio" name="2_13" class="form-check-input p2_13" value="7">
                                        <label class="form-check-label" for="materialGroupExample3"> 7. มากกว่า 100,000
                                            บาท</label>
                                    </div>
                                </div>
                            </div>
