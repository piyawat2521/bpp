...
$arrayPage4 = array("", "" . $_POST["h12"] . "", "" . $_POST["h13"] . "", "" . $_POST["h14"] . "", "" . $_POST["h15"] . "", "" . $_POST["h16"] . "", "" . $_POST["cv3"] . "");
...
if ($sumPage4 >= 0.00 and $sumPage4 <= 24.00) {
...
} elseif ($sumPage4 >= 25.00 and $sumPage4 <= 49.99) {
...
} elseif ($sumPage4 >= 50.00 and $sumPage4 <= 74.99) {
...
} elseif ($sumPage4 >= 75.00 and $sumPage4 <= 100) {
    $imgS = '<img src="imgS/s3.png">';
