...
$arrayPage6 = array("", "" . $_POST["h22"] . "", "" . $_POST["h23"] . "", "" . $_POST["h24"] . "", "" . $_POST["cv5"] . "");
...
if ($sumPage6 >= 0.00 and $sumPage6 <= 24.00) {
...
} elseif ($sumPage6 >= 25.00 and $sumPage6 <= 49.99) {
...
} elseif ($sumPage6 >= 50.00 and $sumPage6 <= 74.99) {
...
} elseif ($sumPage6 >= 75.00 and $sumPage6 <= 100) {
    $imgS = '<img src="imgS/s3.png">';
