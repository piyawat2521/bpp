          ...
          <div class="col-sm-12"><!--mainBox-->
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">64. ท่านรู้สึกว่าโดยเฉลี่ยในหนึ่งสัปดาห์ท่านทำงานกี่วัน</label>
                  <!-- Group of material radios - option 1 -->
                  <div class="boxA">
                    <div class="form-check">
                      <input type="radio" name="h64" class="form-check-input" id="h64" value="1">
                      <label class="form-check-label" for="materialGroupExample1"> 1. ทำงาน 1- 2 วัน</label>
                    </div>
                    <!-- Group of material radios - option 2 -->
                    <div class="form-check">
                      <input type="radio" name="h64" class="form-check-input" id="h64" value="2">
                      <label class="form-check-label" for="materialGroupExample2"> 2. ทำงาน 3 - 4 วัน</label>
                    </div>
                    <!-- Group of material radios - option 3 -->
                    <div class="form-check">
                      <input type="radio" name="h64" class="form-check-input" id="h64" value="3">
                      <label class="form-check-label" for="materialGroupExample3"> 3. ทำงาน 5 วัน</label>
                    </div>
                    <!-- Group of material radios - option 4 -->
                    <div class="form-check">
                      <input type="radio" name="h64" class="form-check-input" id="h64" value="4">
                      <label class="form-check-label" for="materialGroupExample2"> 4. ทำงาน 6 วัน</label>
                    </div>
                    <!-- Group of material radios - option 5 -->
                    <div class="form-check">
                      <input type="radio" name="h64" class="form-check-input" id="h64" value="5">
                      <label class="form-check-label" for="materialGroupExample3"> 5. ทำงาน 7 วัน (ทุกวัน)</label>
                    </div>
                  </div>
                </div>
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">65. ท่านรู้สึกว่าโดยเฉลี่ยท่านทำงานวันละกี่ชั่วโมง</label>
                  <!-- Group of material radios - option 1 -->
                  <div class="boxA">
                    <div class="form-check">
                      <input type="radio" name="h65" class="form-check-input" id="h65" value="1">
                      <label class="form-check-label" for="materialGroupExample1"> 1. น้อยกว่า 6 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 2 -->
                    <div class="form-check">
                      <input type="radio" name="h65" class="form-check-input" id="h65" value="2">
                      <label class="form-check-label" for="materialGroupExample2"> 2. 6 - 8 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 3 -->
                    <div class="form-check">
                      <input type="radio" name="h65" class="form-check-input" id="h65" value="3">
                      <label class="form-check-label" for="materialGroupExample3"> 3. 9 - 10 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 4 -->
                    <div class="form-check">
                      <input type="radio" name="h65" class="form-check-input" id="h65" value="4">
                      <label class="form-check-label" for="materialGroupExample2"> 4. 11 - 12 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 5 -->
                    <div class="form-check">
                      <input type="radio" name="h65" class="form-check-input" id="h65" value="5">
                      <label class="form-check-label" for="materialGroupExample3"> 5. มากกว่า 12  ชั่วโมง</label>
                    </div>
                  </div>
                </div>
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">66. ท่านรู้สึกว่า ได้พักผ่อนโดยเฉลี่ย (ไม่รวมการนอนหลับตอนกลางคืน) วันละกี่ชั่วโมง</label>
                  <!-- Group of material radios - option 1 -->
                  <div class="boxA">
                    <div class="form-check">
                      <input type="radio" name="h66" class="form-check-input" id="h66" value="1">
                      <label class="form-check-label" for="materialGroupExample1"> 1. น้อยกว่า 1 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 2 -->
                    <div class="form-check">
                      <input type="radio" name="h66" class="form-check-input" id="h66" value="2">
                      <label class="form-check-label" for="materialGroupExample2"> 2. 1 - 2 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 3 -->
                    <div class="form-check">
                      <input type="radio" name="h66" class="form-check-input" id="h66" value="3">
                      <label class="form-check-label" for="materialGroupExample3"> 3. 3 - 5 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 4 -->
                    <div class="form-check">
                      <input type="radio" name="h66" class="form-check-input" id="h66" value="4">
                      <label class="form-check-label" for="materialGroupExample2"> 4. 6 - 7 ชั่วโมง</label>
                    </div>
                    <!-- Group of material radios - option 5 -->
                    <div class="form-check">
                      <input type="radio" name="h66" class="form-check-input" id="h66" value="5">
                      <label class="form-check-label" for="materialGroupExample3"> 5. 8  ชั่วโมง</label>
                    </div>
                  </div>
                </div>
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">67. หน่วยงานของท่าน มีความยืดหยุ่น ในการทำงานหรือไม่ (เช่น ความยืดหยุ่นในการทำงานนอกสถานที่ ไม่ต้องเข้างาน/ ออกงานตามเวลาที่กำหนด/ สามารถเลือกวันหยุดของตนเองได้ ฯลฯ)</label>
                  <!-- Group of material radios - option 1 -->
                  <div class="boxA">
                    <div class="form-check">
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">68.ท่านทำงานตรงตามวุฒิการศึกษาหรือไม่</label>
                  <!-- Group of material radios - option 1 -->
                  <div class="boxA">
                    <div class="form-check">
                      <input type="radio" name="h68" class="form-check-input" id="h68" value="1">
                      <label class="form-check-label" for="materialGroupExample1"> 1. ไม่ตรงตามวุฒิ/ น้อยที่สุด</label>
                    </div>
                    <!-- Group of material radios - option 2 -->
                    <div class="form-check">
            ...
            <div class="container boxQ">
              <div class="row">
                <div class="col-sm-12">
                  <!-- Default input -->
                  <label for="exampleForm2" class="textQ">69. ปัจจุบัน ความสุข ของท่านอยู่ในระดับใด ขอให้ท่านกากบาท X ลงบนเส้นด้านล่างโดยคะแนนจะเรียงจากน้อยไปหามาก เริ่มจาก 0 หมายถึง ไม่มีความสุขเลย ไปจนถึง 10 หมายถึง มีความสุขที่สุด</label>
                  <!-- Group of material radios - option 1 -->

                 
                  <!--<input type="range" class="custom-range" min="0" max="10" step="0.1" id="customRange3" name="h69">-->
                  <input type="text" id="amount" name="h69" readonly style="border:0; color:#f6931f; font-weight:bold; font-size: 20px;">
                  <div align='center'> <div id="slider" style="width: 99%"></div></div>
