        ...
        <div class="col-sm-12"><!--mainBox-->
          ...
          <div class="container boxQ">
            <div class="row">
              <div class="col-sm-12">
                <!-- Default input -->
                <label for="exampleForm2" class="textQ">34. ท่านรู้สึกว่า การผ่อนชำระหนี้สินต่างๆ โดยรวมของท่านในปัจจุบันเป็นภาระ หรือไม่</label>
                <!-- Group of material radios - option 1 -->
                <div class="boxA">
                  <div class="form-check">
                    <input type="radio" name="h34" class="form-check-input" id="h34" value="1">
                    <label class="form-check-label" for="materialGroupExample1"> 1. เป็นภาระหนักที่สุด</label>
                  </div>
                  <!-- Group of material radios - option 2 -->
                  <div class="form-check">
                    <input type="radio" name="h34" class="form-check-input" id="h34" value="2">
                    <label class="form-check-label" for="materialGroupExample2"> 2. เป็นภาระหนักมาก</label>
                  </div>
                  <!-- Group of material radios - option 3 -->
                  <div class="form-check">
                    <input type="radio" name="h34" class="form-check-input" id="h34" value="3">
                    <label class="form-check-label" for="materialGroupExample3"> 3. เป็นภาระปานกลาง</label>
                  </div>
                  <!-- Group of material radios - option 4 -->
                  <div class="form-check">
                    <input type="radio" name="h34" class="form-check-input" id="h34" value="4">
                    <label class="form-check-label" for="materialGroupExample2"> 4. เป็นภาระน้อย</label>
                  </div>
                  <!-- Group of material radios - option 5 -->
                  <div class="form-check">
                    <input type="radio" name="h34" class="form-check-input" id="h34" value="5">
                    <label class="form-check-label" for="materialGroupExample3"> 5. ไม่เป็นภาระ/ ไม่ได้ผ่อนชำระ/ ไม่มีหนี้สิน</label>
                  </div>
                </div>
              </div>
          ...
          <div class="container boxQ">
            <div class="row">
              <div class="col-sm-12">
                <!-- Default input -->
                <label for="exampleForm2" class="textQ">35. ท่านผ่อนชำระหนี้ ตามกำหนดเวลาทุกครั้ง หรือไม่</label>
                <!-- Group of material radios - option 1 -->
                <div class="boxA">
                  <div class="form-check">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="materialGroupExample3"> 3. ตรงเวลาบ้างบางครั้ง</label>
                  </div>
                  <!-- Group of material radios - option 4 -->
                  <div class="form-check">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="materialGroupExample3"> 5. ตรงเวลาทุกครั้ง/ ไม่ได้ผ่อนชำระ/ ไม่มีหนี้สิน</label>
                  </div>
                </div>
              </div>
          ...
          <div class="container boxQ">
            <div class="row">
              <div class="col-sm-12">
                <!-- Default input -->
                <label for="exampleForm2" class="textQ">36. โดยรวมแล้ว ท่านมีเงินเก็บออมในแต่ละเดือนหรือไม่</label>
                <!-- Group of material radios - option 1 -->
                <div class="boxA">
                  <div class="form-check">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="materialGroupExample2"> 2. มี/ เก็บออมเพียงเล็กน้อย</label>
                  </div>
                  <!-- Group of material radios - option 3 -->
                  <div class="form-check">
                    <input type="radio" name="h36" class="form-check-input" id="h36" value="3">
                    <label class="form-check-label" for="materialGroupExample3"> 3. มี/ เก็บออมปานกลาง</label>
                  </div>
                  <!-- Group of material radios - option 4 -->
                  <div class="form-check">
                    <input type="radio" name="h36" class="form-check-input" id="h36" value="4">
                    <label class="form-check-label" for="materialGroupExample2"> 4. มี/ เก็บออมมาก</label>
                  </div>
                  <!-- Group of material radios - option 5 -->
                  <div class="form-check">
                    <input type="radio" name="h36" class="form-check-input" id="h36" value="5">
                    <label class="form-check-label" for="materialGroupExample3"> 5. มี/ เก็บออมมากที่สุด</label>
                  </div>
                </div>
              </div>
          ...
          <div class="container boxQ">
            <div class="row">
              <div class="col-sm-12">
                <!-- Default input -->
                <label for="exampleForm2" class="textQ">37. โดยรวมแล้ว ค่าตอบแทนที่ท่านได้รับทั้งหมดในแต่ละเดือนเป็นอย่างไร เมื่อเปรียบเทียบกับรายจ่ายทั้งหมดในแต่ละเดือน</label>
                <!-- Group of material radios - option 1 -->
                <div class="boxA">
                  <div class="form-check">
                    <input type="radio" name="h37" class="form-check-input" id="h37" value="1">
                    <label class="form-check-label" for="materialGroupExample1"> 1. รายจ่ายเกินกว่ารายได้มาก</label>
                  </div>
                  <!-- Group of material radios - option 2 -->
                  <div class="form-check">
                    <input type="radio" name="h37" class="form-check-input" id="h37" value="2">
                    <label class="form-check-label" for="materialGroupExample2"> 2. รายจ่ายเกินกว่ารายได้เล็กน้อย</label>
                  </div>
                  <!-- Group of material radios - option 3 -->
                  <div class="form-check">
                    <input type="radio" name="h37" class="form-check-input" id="h37" value="3">
                    <label class="form-check-label" for="materialGroupExample3"> 3. รายจ่ายพอๆ กับรายได้</label>
                  </div>
                  <!-- Group of material radios - option 4 -->
                  <div class="form-check">
                    <input type="radio" name="h37" class="form-check-input" id="h37" value="4">
                    <label class="form-check-label" for="materialGroupExample2"> 4. รายจ่ายน้อยกว่ารายได้</label>
                  </div>
                  <!-- Group of material radios - option 5 -->
                  <div class="form-check">
                    <input type="radio" name="h37" class="form-check-input" id="h37" value="5">
                    <label class="form-check-label" for="materialGroupExample3"> 5. รายจ่ายน้อยกว่ารายได้มาก</label>
                  </div>
                </div>
              </div>
